...
int main()
{
	...
	GLR::Shader shader("SimpleShader", "D:/Programming/GLDemos/TriangleDemo/res/shaders/triangleDemo.vert", "D:/Programming/GLDemos/TriangleDemo/res/shaders/triangleDemo.frag");
	...
	GLR::Shader::GetItem("SimpleShader")->GetUniform("Color")->Set(glm::vec3(0.0f, 1.0f, 1.0f));
